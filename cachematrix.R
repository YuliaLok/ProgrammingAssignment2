...
##makeCacheMatrix creates a "special matrix" + has a function to:
...
##cacheSolve function computes and returns the inverse of the "special matrix". 
## It first checks if the inverse has already been computed. 
## If so - it gets the inverse result from the cache and skips the computation. 
## If not - it computes the inverse of the matrix and sets the value in the cache via setinverse function.#
